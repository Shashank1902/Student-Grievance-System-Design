      ...
      <div className="App">
        ...
        <div>
          ...
          <p className="category-writeup">
            ...
            return of any book or any other related queries. For lab, you can
            post to enquire about lab timings, lab functionality rules and norms
            laid down by the institution. The solutions to your query shall be
            reverted.
          </p>
        </div>
        <Grievanceform />
