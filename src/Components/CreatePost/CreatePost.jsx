    ...
    <div className="uploadpost-container">
      ...
      <div className="addpost">
        ...
        <div className="">
          ...
          <span>
            <img className="PostLogo" src="assets/PostLogo/tag.png" alt="" />
          </span>
          <span>
            <img className="PostLogo" src="assets/PostLogo/emoji.png" alt="" />
          </span>
          <span>
            <img
              className="PostLogo"
              src="assets/PostLogo/location.png"
              alt=""
            />
          </span>
          <span>
            <img className="PostLogo" src="assets/PostLogo/flag.png" alt="" />
          </span>
          <span>
            <img className="PostLogo" src="assets/PostLogo/more.png" alt="" />
          </span>
        </div>
      </div>
